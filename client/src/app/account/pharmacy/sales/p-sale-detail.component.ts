...
export class PSaleDetailComponent implements OnInit {
  sale: any;
  ...
  back() {
    this.router.navigateByUrl('account/pharmacy/sales');
  }

  getSale() {
    this.pharmaciesService.getSale(this.route.snapshot.paramMap.get('id')).subscribe(response => {
